...
const PinDescription g_APinDescription[]=
{
  ...
  // UART OBDH (Serial1) - SERCOM 0 {19-20}
  ...
  // UART GPS (Serial2) - SERCOM 1 {21-22}
  ...
  // SD SPI - SERCOM 5 {29-31}
  { PORTB,  0,  PIO_SERCOM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_0  }, // MISO: PAD[2]
  { PORTB,  3,  PIO_SERCOM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_3  }, // SCK: PAD[1]
  { PORTB,  2,  PIO_SERCOM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_2  }, // MOSI: PAD[0]
